package xyz.zip8919.mcplugin.examcountdown.commands;
...
public class ExamCountdownCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "reload":
                // 检查权限
                if (!sender.hasPermission("examcountdown.admin")) {
